...
# Define a regex pattern for binary numbers that are multiples of 3
PATTERN = re.compile(r'^(0*(1(01*0)*1)*)*$')

print(PATTERN.match('000')) # match  
print(PATTERN.match('001')) # no match 
print(PATTERN.match('011'))  # match
print(PATTERN.match('110'))  # match
